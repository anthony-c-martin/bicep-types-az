...
* **fqdn**: string (ReadOnly): Fully qualified domain name of the host.
...
* **password**: string: The password of the Active Directory user with a minimum of read-only access to
...
* **value**: string (Required): The value of the label.
