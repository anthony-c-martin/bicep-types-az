...
* **groupName**: string (Required): [Required] Group within the same pool with which this endpoint needs to be associated with.
...
* **modelId**: string (Required): [Required] Target Marketplace Model ID to create a Marketplace Subscription for.
