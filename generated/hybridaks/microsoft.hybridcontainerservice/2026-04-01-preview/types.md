...
## SecurityProfile
### Properties
* **customCATrustCertificates**: any[]: The list of base64 encoded certificate strings that will be added to the node trust store. At most 10 certificates can be provided.
