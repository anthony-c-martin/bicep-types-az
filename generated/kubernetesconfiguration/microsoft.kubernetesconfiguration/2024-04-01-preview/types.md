...
## TlsConfigDefinition
### Properties
* **caCertificate**: string: Base64-encoded CA certificate used to verify the server.
* **clientCertificate**: string: Base64-encoded certificate used to authenticate a client with the OCI repository.
* **privateKey**: string: Base64-encoded private key used to authenticate a client with the OCI repository.
