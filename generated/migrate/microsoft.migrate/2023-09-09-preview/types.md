...
* **laborCostPercentage**: int: Gets Azure arc labour cost percentage.
...
## AzureSettings
### Properties
* **avsLaborCostPercentage**: int: Gets Avs labour cost percentage.
...
* **discountPercentage**: int: Gets azure Discount percentage.
* **iaasLaborCostPercentage**: int: Gets IaaS labour cost percentage.
* **infrastructureGrowthRate**: int: Gets infrastructure growth rate.
* **networkCostPercentage**: int: Gets network cost percentage.
* **paasLaborCostPercentage**: int: Gets PaaS labour cost percentage.
...
* **performanceUtilizationPercentile**: int: Gets utilization percentile for performance.
...
* **numberOfPhysicalCoresPerLicense**: int (Required): Number of physical cores per licence.
...
* **physicalServersPerAdmin**: int (Required): Physical servers per administrator.
* **virtualMachinesPerAdmin**: int (Required): Virtual machines per administrator.
...
## NetworkSettings
### Properties
* **hardwareSoftwareCostPercentage**: int (Required): Network hardware and software cost percentage.
* **maintenanceCostPercentage**: int (Required): Network maintenance cost percentage.
...
* **maintainanceCostPercentageToAcquisitionCost**: int (Required): Maintenance cost percentage.
