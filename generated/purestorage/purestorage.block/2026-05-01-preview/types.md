...
### Properties
* **datastore**: string (ReadOnly): VMware datastore associated with this storage container (if any)
...
* **resourceName**: string (Required, ReadOnly): Name of the storage container
...
* **provisionedSize**: int: Currently provisioned size of the volume, in bytes
...
### Properties
* **activationCode**: string (Required): One-time activation code for platform console access
