...
* **sourceTenantId**: string (ReadOnly): Tenant ID of the source vault for cross-tenant mapping.
...
* **aadTenantId**: string: AAD tenant ID of the source vault.
...
* **servicePrincipalClientId**: string: Service principal client ID for the vault.
* **servicePrincipalObjectId**: string: Service principal object ID for the vault.
