...
* **creationMethod**: int: Resource creation method of mcc cache node resource, cli or portal
...
### Properties
* **cacheNumber**: int: corresponding nginx cache number. Valid cache numbers are 1 - 20
...
* **autoUpdateRequestedDay**: int: Customer requested day of week for mcc install of auto update cycle. 0 is default no selection. 1-7 are days of week, 1 is Sunday, 2 is Monday, etc.
* **autoUpdateRequestedTime**: string: Customer requested time of the day for mcc install of auto update cycle, should be hh:mm
* **autoUpdateRequestedWeek**: int: Customer requested week of month for mcc install of auto update cycle. 0 is default no selection. 1-5 are valid weeks of month, 1 is first week, 2 is second week, etc.
...
* **verifySignupPhrase**: string (WriteOnly): Customer resource phrase for verifying signup.
