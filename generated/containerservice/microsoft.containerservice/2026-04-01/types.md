...
* **serverAppSecret**: string (WriteOnly): (DEPRECATED) The server AAD application secret. Learn more at https://aka.ms/aks/aad-legacy.
...
* **secret**: string (WriteOnly): The secret password associated with the service principal in plain text.
