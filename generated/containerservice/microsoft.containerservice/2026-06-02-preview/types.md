...
## MemberSelector
### Properties
* **byLabel**: string (Required): Kubernetes-style label selector for selecting Fleet members, e.g. `env=production`.
...
* **startTime**: string (Required): The local time of day when the scheduled start occurs in 24-hour (HH:mm) format.
* **utcOffset**: string (Required): The UTC offset for the scheduled time in HH:mm format, -14:00 to +14:00
...
* **maxAllowedFailures**: string: Limits the number of member (cluster) upgrade failures tolerated within this group.
...
* **maxConcurrency**: string: The max number of upgrades that can run concurrently in this specific group.
...
## UpdateRunGateStatus
### Properties
* **displayName**: string (ReadOnly): The human-readable display name of the Gate.
...
### Properties
* **group**: string (ReadOnly): The Update Group of the Update Run.
* **name**: string (Required, ReadOnly): The name of the Update Run.
* **stage**: string (ReadOnly): The Update Stage of the Update Run.
...
* **maxAllowedFailures**: string: Limits the number of member (cluster) upgrade failures tolerated within this stage.
...
* **maxConcurrency**: string: The max number of upgrades that can run concurrently across all groups in this stage.
