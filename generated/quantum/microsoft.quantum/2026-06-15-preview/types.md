...
## QuotaAllocations
### Properties
* **highMinutesLifetime**: int: Lifetime limit for high priority jobs execution in minutes.
* **standardMinutesLifetime**: int (Required): Lifetime limit for standard priority jobs execution in minutes.
...
* **highMinutesLifetime**: int: Lifetime limit for high priority jobs execution in minutes.
* **standardMinutesLifetime**: int (Required): Lifetime limit for standard priority jobs execution in minutes.
* **targetId**: string (Required): The ID of the Target these quota allocations apply to.
