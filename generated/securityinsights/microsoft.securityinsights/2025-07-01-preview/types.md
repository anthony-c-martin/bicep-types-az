...
* **requestTimeoutInSeconds**: int: Request timeout in seconds.
...
* **csvEscape**: string: The character used to escape characters in CSV.
...
* **cityConfidenceFactor**: int: A numeric rating of confidence that the value in the 'city' field is correct, on a scale of 0-100
* **continent**: string: The continent this IP address is located on
* **country**: string: The county this IP address is located in
* **countryConfidenceFactor**: int: A numeric rating of confidence that the value in the 'country' field is correct on a scale of 0-100
...
* **stateConfidenceFactor**: int: A numeric rating of confidence that the value in the 'state' field is correct on a scale of 0-100
