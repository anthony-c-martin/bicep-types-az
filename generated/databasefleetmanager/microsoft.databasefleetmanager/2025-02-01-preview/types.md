...
## Identity
### Properties
* **federatedClientId**: string: The federated client id for the SQL Database. It is used for cross tenant CMK scenario.
...
## MainPrincipal
### Properties
* **applicationId**: string: Application Id of the main principal.
* **login**: string: Login name of the main principal.
* **objectId**: string: Object Id of the main principal.
* **principalType**: 'Application' | 'User' | string: Principal type of the main principal.
* **tenantId**: string: Tenant Id of the main principal.
