...
### Properties
* **dataCollectionEndpointUrl**: string (Required): Data collection endpoint ingestion url.
* **dataCollectionRule**: string (Required): Data Collection Rule (DCR) immutable id.
* **schema**: [SchemaMap](#schemamap) (Required): The schema mapping for incoming data.
* **stream**: string (Required): Stream name in destination. Azure Monitor stream is related to the destination table.
...
* **name**: string (Required): The name of exporter.
...
* **port**: int: The port that will be configured externally. If not specified, it will use the port from the receiver definition.
* **receiver**: string (Required): The name of the previously defined receiver.
* **subdomain**: string: Route subdomain.

## OtlpReceiver
### Properties
* **endpoint**: string (Required): OTLP GRPC endpoint definition. Example: 0.0.0.0:<port>.
...
* **name**: string (Required): The name of processor.
* **type**: 'Batch' | string (Required): The type of processor.

## Receiver
### Properties
* **name**: string (Required): The name of receiver.
...
## SyslogReceiver
### Properties
* **endpoint**: string (Required): Syslog receiver endpoint definition. Example: 0.0.0.0:<port>.
...
## TcpExporter
### Properties
* **url**: string (Required): TCP url to export.
...
* **endpoint**: string (Required): TCP endpoint definition. Example: 0.0.0.0:<port>.
* **readQueueLength**: int: Max read queue length.
