...
* **evaluationPeriodDays**: int (Required): The time frame (in days) used for SLI evaluation.
* **value**: int (Required): The user-defined or Azure-defined target value used for comparison against the SLI value.
...
* **description**: string (Required): A user-provided description of the SLI, with a maximum length of 1000 characters.
