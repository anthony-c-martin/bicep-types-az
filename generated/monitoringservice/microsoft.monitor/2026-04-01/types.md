...
### Properties
* **maxStorageUsage**: int: Max storage usage in gigabytes.
...
* **name**: string (Required): The name of the TLS configuration.
...
### Properties
* **transformStatement**: string (Required): Transform statement to execute over the data passing through the processor.
