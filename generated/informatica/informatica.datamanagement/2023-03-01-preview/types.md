...
## LinkOrganization
### Properties
* **token**: string (WriteOnly): Link organization token
...
## OfferDetails
### Properties
* **offerId**: string (Required): Id of the product offering.
* **planId**: string (Required): Id of the product offer plan.
* **planName**: string (Required): Name of the product offer plan.
* **publisherId**: string (Required): Id of the product publisher.
* **termId**: string (Required): Offer plan term id.
...
* **phoneNumber**: string: Phone number of the user used by for contacting them if needed
