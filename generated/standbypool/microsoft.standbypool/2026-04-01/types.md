...
* **maxReadyCapacity**: int (Required): Specifies maximum number of standby container groups in the standby pool.
...
### Properties
* **dynamicSizing**: [DynamicSizing](#dynamicsizing): Specifies the dynamic sizing configuration.
* **maxReadyCapacity**: int (Required): Specifies the maximum number of virtual machines in the standby virtual machine pool.
* **minReadyCapacity**: int: Specifies the desired minimum number of virtual machines in the standby virtual machine pool. MinReadyCapacity cannot exceed MaxReadyCapacity.
...
## VmStateDistribution
### Properties
* **deallocatedPercent**: int: Specifies the percentage of virtual machines in the Deallocated state in the standby pool.
* **hibernatedPercent**: int: Specifies the percentage of virtual machines in the Hibernated state in the standby pool.
* **runningPercent**: int: Specifies the percentage of virtual machines in the Running state in the standby pool.
