...
* **administratorLoginPassword**: string (WriteOnly): Administrator login password. If AuthenticationType is ManagedIdentity, this field should not be specified.
...
### Properties
* **tenantId**: string: The DataSync participant identity tenant id
