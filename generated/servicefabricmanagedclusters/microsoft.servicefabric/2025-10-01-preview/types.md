...
## NodeTypeNatConfig
### Properties
* **backendPort**: int: The internal port for the NAT configuration.
* **frontendPortRangeEnd**: int: The port range end for the external endpoint.
* **frontendPortRangeStart**: int: The port range start for the external endpoint.
...
* **vmInstanceCount**: int (Required): The number of nodes in the node type. **Values:** -1 - Use when auto scale rules are configured or sku.capacity is defined 0 - Not supported >0 - Use for manual scale.
...
## NodeTypeSku
### Properties
* **capacity**: int (Required): The number of nodes in the node type. If present in request it will override properties.vmInstanceCount.
