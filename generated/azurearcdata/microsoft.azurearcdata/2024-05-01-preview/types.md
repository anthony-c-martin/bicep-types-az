...
* **fullBackupDays**: int: The value indicating days between full backups.
* **retentionPeriodDays**: int: The retention period for all the databases in this managed instance.
* **transactionLogBackupMinutes**: int: The value indicating minutes between transaction log backups.
...
* **replicaId**: string (ReadOnly): ID GUID of the availability group.
...
### Properties
* **availabilityGroupId**: string (ReadOnly): ID GUID of the availability group.
...
* **physicalCores**: int (Required): The number of total cores of the license covers.
...
* **uniqueId**: string (ReadOnly): The unique ID of this license. This is a GUID-formatted string (e.g. 00000000-0000-0000-0000-000000000000).
