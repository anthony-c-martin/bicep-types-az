...
* **resourceGroup**: string: Resource group where Drill's internal resources will be created. If not specified, defaults to 'AzureResilienceManagementDrills'. This value is immutable after drill creation.
...
### Properties
* **faultName**: string (Required): fault name
* **faultUrn**: string (Required): fault urn.
...
* **name**: string (Required): The name of the recovery orchestration group action.
* **timeoutInMinutes**: int (Required): The maximum amount of time, in minutes, allowed for the action to complete before it times out.
...
### Properties
* **description**: string (Required): A description of the recovery orchestration group.
* **groupUniqueId**: string (Required): A unique id for the recovery orchestration group, which is a GUID.
* **orderId**: int (Required): The order ID of the recovery orchestration group.
* **postActions**: [RecoveryGroupBaseAction](#recoverygroupbaseaction)[]: Post-actions for the recovery orchestration group.
* **preActions**: [RecoveryGroupBaseAction](#recoverygroupbaseaction)[]: Pre-actions for the recovery orchestration group.

## RecoveryGroupsSetting
### Properties
* **additionalGroups**: [RecoveryGroup](#recoverygroup)[]: Additional recovery orchestration group settings.
...
* **planDescription**: string (Required): A description of the recovery orchestration plan.
...
* **recoveryResourceUniqueId**: string (Required): A unique id for the recovery resource, which is a GUID.
...
* **slis**: [SliSelection](#sliselection)[] (Required): The SLIs selected for Drill monitoring. Maximum of two entries: at most one Availability and one Latency. Duplicate types or duplicate SLI Ids are rejected.
