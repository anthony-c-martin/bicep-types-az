...
* **countryCode**: string (Required): The country code of the country/region the data transits through or is stored in.
...
* **countryCode**: string (Required): Country code of the address.
...
## LocalRepresentative
### Properties
* **countryCode**: string (Required): Country code for the country/region the local representative is representing.
