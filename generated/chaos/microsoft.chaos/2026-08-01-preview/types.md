...
* **recommendedRoles**: string[] (ReadOnly): Recommended Azure RBAC role definition GUIDs for this action.
...
* **principalId**: string: The Microsoft Entra principal (object) ID of the identity used by the connection.
...
* **tenantId**: string: The Microsoft Entra tenant ID that the connection identity belongs to.
...
* **name**: string (Required): Unique name for the action.
...
## ScenarioProperties
### Properties
* **actions**: [ScenarioAction](#scenarioaction)[] (Required): Array of actions that define the scenario's orchestration.
