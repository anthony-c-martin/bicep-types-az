...
## AssignedGroup
### Properties
* **objectId**: string: The Entra group object ID (GUID).
...
### Properties
* **maxConcurrentSessionsPerProject**: int: When specified, limits the maximum number of concurrent sessions across all pools in the project.
