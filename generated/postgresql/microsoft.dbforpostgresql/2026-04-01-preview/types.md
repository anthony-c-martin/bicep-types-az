...
## AdminCredentials
### Properties
* **sourceServerPassword**: string (Required, WriteOnly): Password for the user of the source server.
* **targetServerPassword**: string (Required, WriteOnly): Password for the user of the target server.
...
## DatabaseProperties
### Properties
* **charset**: string: Character set of the database.
...
* **geoBackupFederatedIdentityClientId**: string: Client id of multi-tenant Microsoft Entra application for when it is configured to support geographically redundant backups.
...
* **primaryFederatedIdentityClientId**: string: Client id of multi-tenant Microsoft Entra application.
...
### Properties
* **endIpAddress**: string (Required): IP address defining the end of the range of addresses of a firewall rule. Must be expressed in IPv4 format.
* **startIpAddress**: string (Required): IP address defining the start of the range of addresses of a firewall rule. Must be expressed in IPv4 format.
...
* **percentComplete**: int: Percentage completed.
...
* **dbsToMigrate**: string[]: Names of databases to migrate.
...
* **administratorLoginPassword**: string (WriteOnly): Password assigned to the administrator login. As long as password authentication is enabled, this password can be changed at any time.
