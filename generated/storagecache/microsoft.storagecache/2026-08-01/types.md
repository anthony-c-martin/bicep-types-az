...
* **clusterUuid**: string (ReadOnly): The unique identifier of the AML file system cluster.
...
* **percentComplete**: int (ReadOnly): The percentage of expansion job completion.
...
### Properties
* **balancePercent**: int (ReadOnly): The balance percentage (0-100). Represents cumulative progress since the rebalance started. Reported in periodic rebalance status updates. Resets to 0 if the rebalancer node restarts.
...
* **percentComplete**: int (ReadOnly): The percentage of rebalance job completion.
