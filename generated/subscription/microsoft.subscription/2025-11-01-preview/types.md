...
* **sourceOwnerId**: string (ReadOnly): The object id of the user who initiated the transfer request.
* **sourceTenantId**: string (ReadOnly): The id of the tenant where the subscription originally resided.
* **status**: 'Completed' | 'InProgress' | 'Initialized' | string (ReadOnly): Status of the subscription transfer operation.
* **subscriptionId**: string (ReadOnly): The id of the subscription being transferred.
