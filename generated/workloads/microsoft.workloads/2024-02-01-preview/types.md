...
* **queryInputParameters**: [AlertTemplateQueryInputParameter](#alerttemplatequeryinputparameter)[]: Describes the Query Input Parameter properties in alerts template.
* **severity**: int: Severity of the alert. Should be an integer between [0-4]. Value of 0 is most severe and value of 4 is least severe.
...
### Properties
* **capacity**: int: The number of workers in app service plan. If this is not set or set to 0, auto scale will be configured for the app service plan, otherwise, instance count is set to this number.
...
* **dbPassword**: string: Gets or sets the oracle database password.
* **dbPasswordUri**: string: Gets or sets the key vault URI to secret with the database password.
