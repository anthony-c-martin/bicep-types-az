...
* **changeEnumerationIntervalDays**: int: The interval for enumerating changes on the cloud endpoint.
...
* **inProgressLargeFilePercentComplete**: int (ReadOnly): Percent complete (0-100) of large file currently in progress
* **inProgressLargeFileSizeBytes**: int (ReadOnly): Size in bytes of large file currently in progress
...
* **remainingDeleteCount**: int (ReadOnly): Remaining delete count (if totals are final)
* **remainingDirectoryCount**: int (ReadOnly): Remaining directory count (if totals are final)
* **remainingFileCount**: int (ReadOnly): Remaining file count (if totals are final)
* **remainingLogicalSizeBytes**: int (ReadOnly): Remaining logical size in bytes (if totals are final)
