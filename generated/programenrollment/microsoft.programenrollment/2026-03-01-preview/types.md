...
## DomainGroup
### Properties
* **domainNames**: string[] (Required): The edu domain names in this group.
...
* **tenantId**: string: The Entra tenant ID that owns these domains. Defaults to the caller's tenant if omitted.

## EduEnrollmentProperties
### Properties
* **domains**: [DomainGroup](#domaingroup)[] (Required): The domain groups associated with this enrollment.
