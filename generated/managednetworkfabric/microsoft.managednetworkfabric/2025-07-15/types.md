...
* **stationPort**: int: Port of the station. Default value is 5000.

## BmpExportPolicyProperties
### Properties
* **exportPolicies**: 'All' | 'LocalRib' | 'Post-Policy' | 'Pre-Policy' | string[]: Export Policy for the BGP Monitoring Protocol (BMP) Configuration.
...
### Properties
* **flags**: string[]: Flags that need to be matched. Example: established | initial | <List-of-TCP-flags>. List of eligible TCP Flags are ack, cwr, ece, fin, psh, rst, syn, urg, established
* **icmpConfiguration**: [IcmpConfigurationProperties](#icmpconfigurationproperties): Internet Control Message Protocol (ICMP) configuration
...
* **matchConfigurations**: [ControlPlaneAclMatchConfigurationProperties](#controlplaneaclmatchconfigurationproperties)[]: Access Control List (ACL) match configurations.
...
* **peerASN**: int (Required): Peer ASN number.Example : 28
...
* **vlanId**: int (Required): Vlan identifier. Example : 501
...
### Properties
* **addressList**: string[]: List of source remote IP to be allowed or denied.
* **headerName**: string: Name of the header.

## IcmpConfigurationProperties
### Properties
* **icmpTypes**: string[]: Internet Control Message Protocol (ICMP) types
...
* **neighborIpExclusions**: string[]: BMP Collector Address.
...
### Properties
* **prefixLimits**: [PrefixLimitProperties](#prefixlimitproperties)[]: Prefix limits
...
* **serialNumber**: string (Required): Serial number of the device. Format of serial Number - Make;Model;HardwareRevisionId;SerialNumber.
* **version**: string (ReadOnly): Current version of the device as defined in SKU.
...
* **hardwareAlertThreshold**: int: Hardware alert threshold percentage. Possible values are from 20 to 100.
...
* **storageArrayCount**: int: Number of Storage arrays associated with the Network Fabric.
...
* **peerASN**: int (Required): ASN of PE devices for CE/PE connectivity.Example : 28
* **peLoopbackIpAddress**: string[]: Provider Edge (PE) Loopback IP Address.
* **prefixLimits**: [OptionBLayer3PrefixLimitProperties](#optionblayer3prefixlimitproperties)[]: OptionB Layer3 prefix limit configuration.
* **primaryIpv4Prefix**: string: IPv4 Address Prefix.
* **primaryIpv6Prefix**: string: IPv6 Address Prefix.
* **secondaryIpv4Prefix**: string: Secondary IPv4 Address Prefix.
* **secondaryIpv6Prefix**: string: Secondary IPv6 Address Prefix.
* **vlanId**: int (Required): VLAN for CE/PE Layer 3 connectivity.Example : 501
...
### Properties
* **keepaliveIdleTime**: int: Connection keepalive idle time in seconds
* **probeCount**: int: Probe count, default value is 10
* **probeInterval**: int: Probe interval in seconds, default value is 60
...
* **password**: string (Required): Password for the terminal server connection.
...
* **username**: string (Required): Username for the terminal server connection.
...
## VlanMatchCondition
### Properties
* **innerVlans**: string[]: List of inner vlans that need to be matched.Inputs can be single vlan or the range of vlans.
* **vlanGroupNames**: string[]: List of vlan group names that need to be matched.
* **vlans**: string[]: List of vlans that need to be matched. Inputs can be single vlan or the range of vlans.
...
* **secondaryIpv4Prefix**: string: Secondary IPv4 Address Prefix.
* **secondaryIpv6Prefix**: string: Secondary IPv6 Address Prefix.
* **vlanId**: int (Required): Vlan Id.Example : 501
