...
### Properties
* **addressPrefixes**: string[] (Required): The list of address prefixes in CIDR notation. Supports both IPv4 and IPv6 CIDR notation (e.g. '10.0.0.0/16', '2001:db8::/32').
...
### Properties
* **maxCapacity**: int: The maximum number of capacity units for this azure firewall. Use null to reset the value to the service default.
* **minCapacity**: int: The minimum number of capacity units for this azure firewall. Use null to reset the value to the service default.
...
* **port**: int: Port to use for the endpoint (0-65535).
...
* **diagnosticOperations**: 'ConnectivityCheck' | 'ExpressRouteDiagnostic' | 'NSG' | 'NextHop' | 'PortScan' | string[] (Required): List of diagnostic operations to run.
* **diagnosticOperationsSettings**: [DiagnosticOperationsSettings](#diagnosticoperationssettings): Per-operation diagnostic settings.
* **expiryInDays**: int: Time-to-live (days) before the analyzer expires.
...
* **minimumActivePortsRequired**: int: Minimum number of active ports required for LAG.
* **mtu**: string (ReadOnly): Maximum transmission unit of the LAG.
* **numberOfPorts**: int: Number of ports in the LAG.
...
* **privateIPAddressPrefixLength**: int: The private IP address prefix length. If specified and the allocation method is dynamic, the service will allocate a CIDR block instead of a single IP address.
...
* **nvaInterfaceConfigurations**: [NvaInterfaceConfigurationsProperties](#nvainterfaceconfigurationsproperties)[]: The NVA in VNet interface configurations
...
### Properties
* **name**: string: Specifies the name of the interface. Maximum length is 70 characters.
...
### Properties
* **fileCount**: int: Number of file count. Default value of count is 10 and maximum number is 10000.
* **fileSizeInBytes**: int: Number of bytes captured per packet. Default value in bytes 104857600 (100MB) and maximum in bytes 4294967295 (4GB).
* **sessionTimeLimitInSeconds**: int: Maximum duration of the capture session in seconds is 604800s (7 days) for a file. Default value in second 86400s (1 day).
...
## PolicySettings
### Properties
* **captchaExpirationInMins**: int: Web Application Firewall CAPTCHA Cookie Expiration time in minutes.
...
* **fileUploadLimitInMb**: int: Maximum file upload size in Mb for WAF.
* **jsChallengeCookieExpirationInMins**: int: Web Application Firewall JavaScript Challenge Cookie Expiration time in minutes.
...
* **radiusServerSecret**: string: Radius server secret
...
## RouteNextHopEcmp
### Properties
* **nextHopIpAddresses**: string[] (Required): List of next hop IP addresses for ECMP routing. Must contain between 2 and 64 IP addresses.
...
* **sharedKeyLength**: int: The length of the shared key for the vpn link connection.
...
* **size**: int: Size of the subgroup profile.
