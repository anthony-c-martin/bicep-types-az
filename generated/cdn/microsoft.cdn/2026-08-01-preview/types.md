...
#### Properties
* **allowedFqdns**: string[]: List of FQDNs that will be accepted for mutual TLS validation.
...
* **customCertificateSubjects**: string[]: The list of custom certificate subjects to validate against. Only applicable when certificateNameCheckValidationMode is 'CustomCertificateSubject'. Must contain 1 or 2 entries.
* **deploymentStatus**: 'Failed' | 'InProgress' | 'NotStarted' | 'Succeeded' | string (ReadOnly)
...
### Properties
* **capacityConsciousThreshold**: int: Threshold at which additional backends are added for capacity based load balancing. Default is 80 percent.
