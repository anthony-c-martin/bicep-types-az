...
* **hostname**: string (Required): The hostname for the cloud VM cluster. Hostname and domain combined length cannot exceed 112 characters.
...
### Properties
* **description**: string: A short, non-sensitive description of the managed identity resource. Do not include secrets or customer data. Maximum length is 1024 characters.
