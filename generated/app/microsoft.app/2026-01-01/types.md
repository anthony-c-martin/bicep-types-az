...
* **dataSource**: string: Data source connection string or endpoint
...
* **connectionString**: string: The connection string for the Application Insights resource
...
### Properties
* **connectionKey**: string: The key for the connection
