...
* **requestedDaysOfTheMonth**: int[] (Required): The days of the month the scheduled action is supposed to run on. If empty, it means it will run on every day of the month.
