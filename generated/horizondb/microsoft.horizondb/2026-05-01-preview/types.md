...
* **principalName**: string (Required): The display name or UPN of the Entra ID principal. For users, typically the User Principal Name (e.g., admin@contoso.com). For groups, the group display name. For service principals, the application display name.
...
### Properties
* **administratorLogin**: string (Required): The administrator login name.
* **administratorLoginPassword**: string (WriteOnly): The administrator login password.
