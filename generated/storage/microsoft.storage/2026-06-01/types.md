...
* **timeToLive**: int: The Time to Live (TTL) in days (1–30) for this container. Blobs in the container that have not been accessed within this number of days will be automatically deleted. If not specified at creation time, it defaults to 1 day.
...
### DataShareConnection
#### Properties
* **dataShareUri**: string (Required): The URI of the backing DataShare. Must be in the format: azds://<region>:<DataShareName>:<DataShareIdentifier>
...
* **principalId**: string (Required): The AAD principal ID of the Managed Identity.
* **tenantId**: string (Required): The AAD tenant ID of the Managed Identity.
...
* **dataShareIdentifier**: string (ReadOnly): System-generated GUID identifier for the Storage DataShare. Not a valid input parameter when creating.
* **dataShareUri**: string (ReadOnly): The DataShare URI to be shared with the consumer.
