...
### Properties
* **capacity**: int (Required): Total capacity to achieve. It can be in terms of VMs or vCPUs.
...
### Properties
* **name**: string (Required): The name of the VM size, eg Standard_D2ads_v5
...
* **requestedDaysOfTheMonth**: int[]: The calendar days when the action runs. An empty array means every day of the month.
...
### Properties
* **max**: int: Maximum value. Must be greater than zero. Double.MaxValue(1.7976931348623157E+308).
* **min**: int: Minimum value. If not specified, no minimum filter is applied.
